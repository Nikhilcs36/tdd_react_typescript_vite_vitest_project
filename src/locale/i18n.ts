    ...
    en: {
      translation: {
        ...
        dashboard: {
          ...
          user_total_logins_value: "{{count}} ({{successful}} success, {{failed}} failed)",
          user_total_logins_label: "Total Logins",
          last_login: "Last Login",
          login_trend: "Login Trend",
          error_loading_data: "Error loading dashboard data",
          loading: "Loading...",
          load_more: "Load More",
          all_records_loaded: "All records loaded",
        ...
        emailVerification: {
          ...
          invalidLink: "Invalid verification link. Please check the link and try again.",
        },
      },
    },
    ml: {
      ...
      translation: {
        ...
        dashboard: {
          ...
          user_total_logins_value: "{{count}} ({{successful}} വിജയം, {{failed}} പരാജയം)",
          user_total_logins_label: "ആകെ ലോഗിനുകൾ",
          ...
          all_records_loaded: "എല്ലാ റെക്കോർഡുകളും ലോഡ് ചെയ്തു",
        ...
        emailVerification: {
          ...
          errors: {
            title: "ഇമെയിൽ വെരിഫിക്കേഷൻ പിശക്",
            expired: "ലിങ്കിന്റെ കാലാവധി കഴിഞ്ഞു. പുതിയത് അഭ്യർത്ഥിക്കുക.",
            invalid: "അസാധുവായ വെരിഫിക്കേഷൻ ടോക്കൺ.",
          },
          resend: {
            button: "വെരിഫിക്കേഷൻ ഇമെയിൽ വീണ്ടും അയക്കുക",
            success: "വെരിഫിക്കേഷൻ ഇമെയിൽ വിജയകരമായി അയച്ചു.",
            error: "വെരിഫിക്കേഷൻ ഇമെയിൽ അയക്കുന്നതിൽ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.",
            emailPlaceholder: "നിങ്ങളുടെ ഇമെയിൽ വിലാസം നൽകുക",
            sending: "അയയ്ക്കുന്നു...",
          },
          alreadyVerified: "ഇമെയിൽ ഇതിനകം വെരിഫൈ ചെയ്തിട്ടുണ്ട്.",
          backToLogin: "ലോഗിനിലേക്ക് മടങ്ങുക",
          invalidLink: "അസാധുവായ വെരിഫിക്കേഷൻ ലിങ്ക്. ദയവായി ലിങ്ക് പരിശോധിച്ച് വീണ്ടും ശ്രമിക്കുക.",
        },
      },
    },
    ar: {
      ...
      translation: {
        ...
        dashboard: {
          ...
          user_total_logins_value: "{{count}} ({{successful}} نجح, {{failed}} فشل)",
          user_total_logins_label: "إجمالي عمليات تسجيل الدخول",
          last_login: "آخر تسجيل دخول",
          login_trend: "اتجاه تسجيل الدخول",
          error_loading_data: "خطأ في تحميل بيانات لوحة التحكم",
          loading: "جاري التحميل...",
          load_more: "تحميل المزيد",
          all_records_loaded: "تم تحميل جميع السجلات",
        ...
        emailVerification: {
          ...
          errors: {
            title: "خطأ التحقق من البريد الإلكتروني",
            expired: "انتهت صلاحية الرابط. يرجى طلب رابط جديد.",
            invalid: "رمز التحقق غير صالح.",
          },
          resend: {
            button: "إعادة إرسال بريد التحقق",
            success: "تم إرسال بريد التحقق بنجاح.",
            error: "فشل إرسال بريد التحقق. يرجى المحاولة مرة أخرى.",
            emailPlaceholder: "أدخل عنوان بريدك الإلكتروني",
            sending: "جاري الإرسال...",
          },
          alreadyVerified: "تم التحقق من البريد الإلكتروني مسبقاً.",
          backToLogin: "العودة إلى تسجيل الدخول",
          invalidLink: "رابط التحقق غير صالح. يرجى التحقق من الرابط والمحاولة مرة أخرى.",
        },
      },
    },
  },
