...
i18n.use(initReactI18next).init({
  ...
  resources: {
    en: {
      translation: {
        home: "Home",
        welcomeTitle: "Login Tracking Dashboard",
        ...
        homepage: {
          ...
          features: {
            ...
            profileDesc: "Update your profile, upload avatar images, and manage account settings.",
            userlist: "User List (Admin)",
            userlistDesc: "Admins can view and manage all registered users with pagination.",
            dashboard: "User Statistics",
            dashboardDesc: "Track your login activity, last login time, and login trends over time.",
            charts: "Charts & Analytics",
            chartsDesc: "Visualize login trends, comparisons, and distributions with interactive charts.",
            admin: "Admin Overview",
            adminDesc: "System-wide statistics including total users, login activity patterns, and authentication metrics.",
            multilang: "Multi-Language Support",
            multilangDesc: "Switch between English (AB), Malayalam (അആ), and Arabic (أب) with full RTL support.",
            ...
            report: "Excel Report Downloads",
            reportDesc: "Download detailed login activity reports in Excel format with individual and grouped modes, date filtering, and admin filters.",
            staff: "Staff Auto Permission",
            staffDesc: "Unlock staff access after 3 logins. Switch between Regular, Staff, and Superuser roles in Profile.",
        ...
        resetPassword: {
          ...
          errors: {
            ...
            password_requirements: "Use upper, lower, and a number.",
            password_mismatch: "Passwords don't match.",
            invalid_token: "Invalid password reset token.",
            expired_token: "Invalid or expired password reset token.",
            email_not_verified: "Please verify your email before resetting password.",
            generic: "An unexpected error occurred.",
          },
        },
    ...
    ml: {
      ...
      translation: {
        home: "ഹോം",
        welcomeTitle: "ലോഗിൻ ട്രാക്കിംഗ് ഡാഷ്ബോർഡ്",
        ...
        homepage: {
          ...
          features: {
            ...
            profile: "പ്രൊഫൈൽ മാനേജ്മെന്റ്",
            profileDesc: "നിങ്ങളുടെ പ്രൊഫൈൽ അപ്ഡേറ്റ് ചെയ്യുക, അവതാർ ചിത്രങ്ങൾ അപ്‌ലോഡ് ചെയ്യുക, അക്കൗണ്ട് ക്രമീകരണങ്ങൾ മാനേജ് ചെയ്യുക.",
            userlist: "ഉപയോക്തൃ പട്ടിക (അഡ്മിൻ)",
            userlistDesc: "അഡ്മിനുകൾക്ക് പേജിനേഷനോടെ എല്ലാ രജിസ്റ്റർ ചെയ്ത ഉപയോക്താക്കളെയും കാണാനും മാനേജ് ചെയ്യാനും കഴിയും.",
            dashboard: "ഉപയോക്തൃ സ്ഥിതിവിവരക്കണക്കുകൾ",
            dashboardDesc: "നിങ്ങളുടെ ലോഗിൻ പ്രവർത്തനം, അവസാന ലോഗിൻ സമയം, ലോഗിൻ ട്രെൻഡുകൾ എന്നിവ ട്രാക്ക് ചെയ്യുക.",
            charts: "ചാർട്ടുകളും അനലിറ്റിക്സും",
            chartsDesc: "ഇന്ററാക്ടീവ് ചാർട്ടുകൾ ഉപയോഗിച്ച് ലോഗിൻ ട്രെൻഡുകൾ, താരതമ്യങ്ങൾ, വിതരണങ്ങൾ ദൃശ്യമാക്കുക.",
            admin: "അഡ്മിൻ അവലോകനം",
            adminDesc: "ആകെ ഉപയോക്താക്കൾ, ലോഗിൻ പ്രവർത്തന പാറ്റേണുകൾ, ആധികാരികത മെട്രിക്സ് എന്നിവയുൾപ്പെടെ സിസ്റ്റം വ്യാപക സ്ഥിതിവിവരക്കണക്കുകൾ.",
            multilang: "ബഹുഭാഷാ പിന്തുണ",
            multilangDesc: "ഇംഗ്ലീഷ് (AB), മലയാളം (അആ), അറബിക് (أب) എന്നിവയ്ക്കിടയിൽ മാറുക. പൂർണ്ണ RTL പിന്തുണയോടെ.",
            theme: "ഡാർക്ക് & ലൈറ്റ് തീം",
            themeDesc: "ഏത് പരിസ്ഥിതിയിലും സുഖപ്രദമായ കാഴ്ചയ്ക്കായി ഡാർക്ക്, ലൈറ്റ് മോഡുകൾക്കിടയിൽ മാറുക.",
            tdd: "ടെസ്റ്റ്-ഡ്രൈവൻ ഡെവലപ്മെന്റ്",
            tddDesc: "വിശ്വസനീയമായ കോഡിനായി React, TypeScript, Vite, Vitest ഉപയോഗിച്ച് TDD തത്വങ്ങളിൽ നിർമ്മിച്ചത്.",
            report: "എക്സൽ റിപ്പോർട്ട് ഡൗൺലോഡുകൾ",
            reportDesc: "വ്യക്തിഗത, ഗ്രൂപ്പ് മോഡുകൾ, തീയതി ഫിൽട്ടറിംഗ്, അഡ്മിൻ ഫിൽട്ടറുകൾ എന്നിവ ഉപയോഗിച്ച് എക്സൽ ഫോർമാറ്റിൽ വിശദമായ ലോഗിൻ പ്രവർത്തന റിപ്പോർട്ടുകൾ ഡൗൺലോഡ് ചെയ്യുക.",
            staff: "സ്റ്റാഫ് ഓട്ടോ അനുമതി",
            staffDesc: "3 ലോഗിനുകൾക്ക് ശേഷം സ്റ്റാഫ് ആക്സസ് അൺലോക്ക് ചെയ്യുക. പ്രൊഫൈലിൽ റെഗുലർ, സ്റ്റാഫ്, സൂപ്പർ യൂസർ റോളുകൾക്കിടയിൽ മാറുക.",
            game: "🎮 വിനോദ സോൺ",
            gameDesc: "ഒരു രസകരമായ ഇടവേള വേണോ? വൃത്തങ്ങൾ വരയ്ക്കുക, നിങ്ങളുടെ സ്കോർ മറികടക്കുക — അനലിറ്റിക്സിൽ നിന്നുള്ള ഒരു കളിയായ രക്ഷപ്പെടൽ.",
          },
          gameSection: {
            title: "ഒരു മാനസിക ഇടവേള എടുക്കുക 🎯",
            subtitle: "വിനോദം അൺലോക്ക് ചെയ്യുക, ഡിജിറ്റൽ വിശകലനത്തിന് പകരം നിങ്ങളുടെ മനസ്സിനെ സ്വതന്ത്രമാക്കുക",
            playButton: "🎯 ഇപ്പോൾ കളിക്കുക",
            hideButton: "ഗെയിം മറയ്ക്കുക",
          },
        },
        ...
        forgotPassword: {
          ...
          email: "ഇമെയിൽ",
          submit: "റീസെറ്റ് ലിങ്ക് അയയ്ക്കുക",
          success: "പാസ്‌വേഡ് റീസെറ്റ് നിർദ്ദേശങ്ങൾക്കായി നിങ്ങളുടെ ഇമെയിൽ പരിശോധിക്കുക.",
          backToLogin: "ലോഗിനിലേക്ക് മടങ്ങുക",
          errors: {
            email_required: "ഇമെയിൽ ആവശ്യമാണ്.",
            email_invalid: "സാധുവായ ഇമെയിൽ വിലാസം നൽകുക.",
            email_not_verified: "പാസ്‌വേഡ് റീസെറ്റ് ചെയ്യുന്നതിന് മുമ്പ് ദയവായി നിങ്ങളുടെ ഇമെയിൽ വെരിഫൈ ചെയ്യുക.",
            generic: "അപ്രതീക്ഷിത പിശക് സംഭവിച്ചു.",
          },
        },
        resetPassword: {
          title: "പാസ്‌വേഡ് റീസെറ്റ് ചെയ്യുക",
          password: "പുതിയ പാസ്‌വേഡ്",
          passwordRepeat: "പാസ്‌വേഡ് സ്ഥിരീകരിക്കുക",
          submit: "പാസ്‌വേഡ് റീസെറ്റ് ചെയ്യുക",
          success: "പാസ്‌വേഡ് വിജയകരമായി റീസെറ്റ് ചെയ്തു. നിങ്ങൾക്ക് ഇപ്പോൾ പുതിയ പാസ്‌വേഡ് ഉപയോഗിച്ച് ലോഗിൻ ചെയ്യാം.",
          goToLogin: "ലോഗിനിലേക്ക് പോകുക",
          errors: {
            password_required: "പാസ്‌വേഡ് ആവശ്യമാണ്.",
            password_too_short: "പാസ്‌വേഡ് കുറഞ്ഞത് 6 അക്ഷരങ്ങളെങ്കിലും ആയിരിക്കണം.",
            password_requirements: "വലിയക്ഷരം, ചെറിയക്ഷരം, നമ്പർ എന്നിവ ഉപയോഗിക്കുക.",
            password_mismatch: "പാസ്‌വേഡുകൾ പൊരുത്തപ്പെടുന്നില്ല.",
            invalid_token: "അസാധുവായ പാസ്‌വേഡ് റീസെറ്റ് ടോക്കൺ.",
            expired_token: "അസാധുവായ അല്ലെങ്കിൽ കാലഹരണപ്പെട്ട പാസ്‌വേഡ് റീസെറ്റ് ടോക്കൺ.",
            email_not_verified: "പാസ്‌വേഡ് റീസെറ്റ് ചെയ്യുന്നതിന് മുമ്പ് ദയവായി നിങ്ങളുടെ ഇമെയിൽ വെരിഫൈ ചെയ്യുക.",
            generic: "അപ്രതീക്ഷിത പിശക് സംഭവിച്ചു.",
          },
        },
        game: {
          title: "ഒരു വൃത്തം വരയ്ക്കുക",
          instruction: "കാൻവാസിൽ ഒരു സമ്പൂർണ്ണ വൃത്തം വരയ്ക്കുക. സ്കോർ കാണുന്നതിന് റിലീസ് ചെയ്യുക!",
          submit: "സ്കോർ സമർപ്പിക്കുക",
          clear: "മായ്ക്കുക",
          drawAgain: "വീണ്ടും വരയ്ക്കുക",
          score: "കൃത്യത: {{score}}%",
          bestScore: "മികച്ച സ്കോർ: {{score}}%",
          noBestScore: "ഇതുവരെ മികച്ച സ്കോർ ഇല്ല",
          loading: "സ്കോർ ചെയ്യുന്നു...",
          error: "സ്കോർ സംരക്ഷിക്കുന്നതിൽ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.",
          disabled: "ഗെയിം വിഭാഗം നിലവിൽ പ്രവർത്തനരഹിതമാണ്.",
          rating: {
            excellent: "മികച്ചത്!",
            good: "നല്ലത്!",
            fair: "മതിയായത്",
            poor: "വീണ്ടും ശ്രമിക്കുക"
          },
          leaderboard: {
            show: "ലീഡർബോർഡ് കാണിക്കുക",
            hide: "ലീഡർബോർഡ് മറയ്ക്കുക",
            title: "ലീഡർബോർഡ്",
            rank: "റാങ്ക്",
            username: "ഉപയോക്തൃനാമം",
            score: "സ്കോർ",
            lastPlayed: "അവസാനം കളിച്ചത്",
            empty: "ഇതുവരെ സ്കോറുകളില്ല",
            error: "ലീഡർബോർഡ് ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു",
    ...
    ar: {
      ...
      translation: {
        home: "الرئيسية",
        welcomeTitle: "لوحة متابعة تسجيل الدخول",
        ...
        homepage: {
          ...
          features: {
            ...
            profileDesc: "تحديث ملفك الشخصي وتحميل صور الصورة الرمزية وإدارة إعدادات الحساب.",
            userlist: "قائمة المستخدمين (المسؤول)",
            userlistDesc: "يمكن للمسؤولين عرض وإدارة جميع المستخدمين المسجلين مع الترقيم الصفحي.",
            dashboard: "إحصائيات المستخدم",
            dashboardDesc: "تتبع نشاط تسجيل الدخول ووقت آخر تسجيل دخول واتجاهات تسجيل الدخول بمرور الوقت.",
            charts: "المخططات والتحليلات",
            chartsDesc: "تصور اتجاهات تسجيل الدخول والمقارنات والتوزيعات باستخدام مخططات تفاعلية.",
            admin: "نظرة عامة للمسؤول",
            adminDesc: "إحصائيات على مستوى النظام تشمل إجمالي المستخدمين وأنماط نشاط تسجيل الدخول ومقاييس المصادقة.",
            multilang: "دعم متعدد اللغات",
            multilangDesc: "التبديل بين الإنجليزية (AB) والمالايالامية (അആ) والعربية (أب) مع دعم RTL الكامل.",
            theme: "الوضع المظلم والفاتح",
            themeDesc: "التبديل بين الوضعين الداكن والفاتح للعرض المريح في أي بيئة.",
            tdd: "التطوير الموجه بالاختبارات",
            tddDesc: "مبني على مبادئ TDD باستخدام React وTypeScript وVite وVitest للحصول على كود موثوق.",
            report: "تحميل تقارير إكسل",
            reportDesc: "قم بتنزيل تقارير نشاط تسجيل الدخول المفصلة بصيغة إكسل مع الأوضاع الفردية والجماعية وتصفية التاريخ ومرشحات المسؤول.",
            staff: "صلاحية الموظف التلقائية",
            staffDesc: "افتح وصول الموظفين بعد 3 عمليات تسجيل دخول. بدّل بين الأدوار العادية والموظف والمستخدم الخارق في الملف الشخصي.",
            game: "🎮 منطقة الترفيه",
            gameDesc: "هل تحتاج إلى استراحة ممتعة؟ ارسم دوائر، تغلب على درجتك — هروب مرح من التحليلات.",
          },
          gameSection: {
            title: "خذ استراحة ذهنية 🎯",
            subtitle: "افتح الترفيه، حرر عقلك بدلاً من التحليل الرقمي",
            playButton: "🎯 العب الآن",
            hideButton: "إخفاء اللعبة",
          },
        },
        myProfile: "ملفي",
        signup: {
        ...
        forgotPassword: {
          ...
          email: "البريد الإلكتروني",
          submit: "إرسال رابط إعادة تعيين",
          success: "تحقق من بريدك الإلكتروني للحصول على تعليمات إعادة تعيين كلمة المرور.",
          backToLogin: "العودة إلى تسجيل الدخول",
          errors: {
            email_required: "البريد الإلكتروني مطلوب.",
            email_invalid: "يرجى إدخال بريد إلكتروني صحيح.",
            email_not_verified: "يرجى التحقق من بريدك الإلكتروني قبل إعادة تعيين كلمة المرور.",
            generic: "حدث خطأ غير متوقع.",
          },
        },
        resetPassword: {
          ...
          errors: {
            ...
            password_requirements: "استخدم حرفًا كبيرًا وحرفًا صغيرًا ورقمًا.",
            password_mismatch: "كلمتا المرور غير متطابقتين.",
            invalid_token: "رمز إعادة تعيين كلمة المرور غير صالح.",
            expired_token: "رمز إعادة تعيين كلمة المرور غير صالح أو منتهي الصلاحية.",
            email_not_verified: "يرجى التحقق من بريدك الإلكتروني قبل إعادة تعيين كلمة المرور.",
            generic: "حدث خطأ غير متوقع.",
          },
        },
        game: {
          title: "ارسم دائرة",
          instruction: "ارسم دائرة مثالية على اللوحة. اتركها لترى درجتك!",
          submit: "إرسال الدرجة",
          clear: "مسح",
          drawAgain: "ارسم مرة أخرى",
          score: "الدقة: {{score}}%",
          bestScore: "أفضل درجة: {{score}}%",
          noBestScore: "لا توجد أفضل درجة بعد",
          loading: "جاري التقييم...",
          error: "فشل في حفظ الدرجة. يرجى المحاولة مرة أخرى.",
          disabled: "قسم اللعبة معطل حاليًا.",
          rating: {
            excellent: "ممتاز!",
            good: "جيد!",
            fair: "مقبول",
          ...
          leaderboard: {
            show: "إظهار لوحة المتصدرين",
            hide: "إخفاء لوحة المتصدرين",
            ...
            error: "فشل في تحميل لوحة المتصدرين",
